package com.bytelicious.phramazing.utils.bottom_navigation;
...
final class BottomNavigationBehavior<V extends View> extends VerticalScrollingBehavior<V> {
    ...
    public BottomNavigationBehavior(Context context, AttributeSet attrs) {
        ...
        mElevation = a.getResourceId(1, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                mElevation, context.getResources().getDisplayMetrics()));
        a.recycle();
    }
